...
function App() {
  ...
  const styles = {
    ...
    sectionTitle: { fontSize: '1.5rem', marginBottom: '1rem', color: darkMode ? '#bb86fc' : '#1e293b' },
    label: { fontWeight: 'bold', display: 'block', marginBottom: '0.5rem' },
    answer: { marginTop: '0.5rem', color: '#2563eb' },
    divider: { height: '1px', backgroundColor: darkMode ? '#444' : '#ddd', margin: '2rem 0' },
    tabBar: { display: 'flex', flexWrap: 'wrap', gap: '10px', justifyContent: 'center', marginBottom: '2rem' },
    tabButton: {
      padding: '0.4rem 1rem',
      borderRadius: '20px',
            ...
            return (
              <div key={wordIndex} style={styles.card}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", alignItems: "center" }}>
                  ...
                  />
                  <button
                    style={{ ...styles.button, backgroundColor: "#f8f1b6ff", whiteSpace: "nowrap", height: "2rem" }}
                ...
                {/* Check / Show Answer buttons */}
                <div style={{ marginTop: "0.5rem" }}>
                  <button
                    style={{ ...styles.button, backgroundColor: "#4cc79e", marginRight: "0.5rem" }}
                    onClick={() => handleCheck(setIndex, wordIndex)}
                  >
                    Check
                  </button>
                  <button
                    style={{ ...styles.button, backgroundColor: "#f18e9f" }}
